...
function addLogging(threshold) {
        ...
        window.document.addEventListener( "DOMContentLoaded", function() {
            ...
            QUnit.done(function(result){
                var blanketVar = window.blanket.getCoverageVariable();
                if (result.passed === 0){
                ...
                }else if ( !window.travisCov.check(blanketVar,{threshold: threshold})){
                    console.log("failed: coverage below threshold");
                    result = {failed:1};
                }
